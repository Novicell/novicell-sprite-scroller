...
parcelRequire = function (modules, cache, entry, globalName) {
  ...
  "spriteScroller.js": [function (require, module, exports) {
    ...
    var spriteScroller = function spriteScroller(_ref) {
      ...
      this.init = function () {
        var element = this.element,
            ...
            rows = this.rows,
            direction = this.direction; // Declare background-position values for when creating tween later

        var backgroundPositionValues; // Initialize stickyfill instance

        var stickyfill = (0, _stickyfill.default)(); // Get the element

        var spriteElement = document.querySelector(".".concat(element)); // Set background size of sprite:

        spriteElement.style.backgroundSize = "".concat(columns * 100, "% ").concat(rows * 100, "%");
        var spriteContainerElement = document.querySelector(".sitcky-wrapper"); // Use stickyfill for IE support

        stickyfill.add(spriteContainerElement); // Initialize the scrollmagic controller

        var controller = new _scrollmagic.default.Controller(); // Create the tween
        ...
        var tween = _gsap.default.to(spriteElement, 1.0, {
          ...
          ease: _gsap.SteppedEase.config(rows - 1)
        }); // Build scene
    ...
    "scrollmagic": "../../node_modules/scrollmagic/scrollmagic/uncompressed/ScrollMagic.js",
    "scrollmagic/scrollmagic/uncompressed/plugins/animation.gsap": "../../node_modules/scrollmagic/scrollmagic/uncompressed/plugins/animation.gsap.js",
